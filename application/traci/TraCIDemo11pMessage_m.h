 ...
 * 
 *     // PBFT Fields
 *     int pbftType = -1; // -1=None, 0=Request, 1=PrePrepare, 2=Prepare, 3=Commit, 4=Reply
 *     int pbftView = 0;
 *     int pbftSeqNum = 0;
 *     int pbftSenderId = -1; // For voting logic
 *     int pbftOriginatorId = -1; // The vehicle ID starting the consensus
 * }
 * </pre>
 */
class VEINS_API TraCIDemo11pMessage : public ::veins::BaseFrame1609_4
{
  ...
  public:
    ...
    virtual int getPbftType() const;
    virtual void setPbftType(int pbftType);
    virtual int getPbftView() const;
    virtual void setPbftView(int pbftView);
    virtual int getPbftSeqNum() const;
    virtual void setPbftSeqNum(int pbftSeqNum);
    virtual int getPbftSenderId() const;
    virtual void setPbftSenderId(int pbftSenderId);
    virtual int getPbftOriginatorId() const;
    virtual void setPbftOriginatorId(int pbftOriginatorId);
};
...
/**
 * Enum generated from <tt>veins/modules/application/traci/TraCIDemo11pMessage.msg:42</tt> by nedtool.
 * <pre>
