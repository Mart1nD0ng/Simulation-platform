...
void TraCIDemo11pMessage::copy(const TraCIDemo11pMessage& other)
{
    ...
    this->pbftType = other.pbftType;
    this->pbftView = other.pbftView;
    this->pbftSeqNum = other.pbftSeqNum;
    this->pbftSenderId = other.pbftSenderId;
    this->pbftOriginatorId = other.pbftOriginatorId;
}
...
void TraCIDemo11pMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->pbftType);
    doParsimPacking(b,this->pbftView);
    doParsimPacking(b,this->pbftSeqNum);
    doParsimPacking(b,this->pbftSenderId);
    doParsimPacking(b,this->pbftOriginatorId);
}
...
void TraCIDemo11pMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->pbftType);
    doParsimUnpacking(b,this->pbftView);
    doParsimUnpacking(b,this->pbftSeqNum);
    doParsimUnpacking(b,this->pbftSenderId);
    doParsimUnpacking(b,this->pbftOriginatorId);
}
...
int TraCIDemo11pMessage::getPbftType() const
{
    return this->pbftType;
}

void TraCIDemo11pMessage::setPbftType(int pbftType)
{
    this->pbftType = pbftType;
}

int TraCIDemo11pMessage::getPbftView() const
{
    return this->pbftView;
}

void TraCIDemo11pMessage::setPbftView(int pbftView)
{
    this->pbftView = pbftView;
}

int TraCIDemo11pMessage::getPbftSeqNum() const
{
    return this->pbftSeqNum;
}

void TraCIDemo11pMessage::setPbftSeqNum(int pbftSeqNum)
{
    this->pbftSeqNum = pbftSeqNum;
}

int TraCIDemo11pMessage::getPbftSenderId() const
{
    return this->pbftSenderId;
}

void TraCIDemo11pMessage::setPbftSenderId(int pbftSenderId)
{
    this->pbftSenderId = pbftSenderId;
}

int TraCIDemo11pMessage::getPbftOriginatorId() const
{
    return this->pbftOriginatorId;
}

void TraCIDemo11pMessage::setPbftOriginatorId(int pbftOriginatorId)
{
    this->pbftOriginatorId = pbftOriginatorId;
}
...
unsigned int TraCIDemo11pMessageDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_pbftType
        FD_ISEDITABLE,    // FIELD_pbftView
        FD_ISEDITABLE,    // FIELD_pbftSeqNum
        FD_ISEDITABLE,    // FIELD_pbftSenderId
        FD_ISEDITABLE,    // FIELD_pbftOriginatorId
    };
...
int TraCIDemo11pMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 'p' && strcmp(fieldName, "pbftType") == 0) return base+3;
    if (fieldName[0] == 'p' && strcmp(fieldName, "pbftView") == 0) return base+4;
    if (fieldName[0] == 'p' && strcmp(fieldName, "pbftSeqNum") == 0) return base+5;
    if (fieldName[0] == 'p' && strcmp(fieldName, "pbftSenderId") == 0) return base+6;
    if (fieldName[0] == 'p' && strcmp(fieldName, "pbftOriginatorId") == 0) return base+7;
...
const char *TraCIDemo11pMessageDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "int",    // FIELD_pbftType
        "int",    // FIELD_pbftView
        "int",    // FIELD_pbftSeqNum
        "int",    // FIELD_pbftSenderId
        "int",    // FIELD_pbftOriginatorId
    };
...
std::string TraCIDemo11pMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_pbftType: return long2string(pp->getPbftType());
        case FIELD_pbftView: return long2string(pp->getPbftView());
        case FIELD_pbftSeqNum: return long2string(pp->getPbftSeqNum());
        case FIELD_pbftSenderId: return long2string(pp->getPbftSenderId());
        case FIELD_pbftOriginatorId: return long2string(pp->getPbftOriginatorId());
        default: return "";
    }
}
...
bool TraCIDemo11pMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_pbftType: pp->setPbftType(string2long(value)); return true;
        case FIELD_pbftView: pp->setPbftView(string2long(value)); return true;
        case FIELD_pbftSeqNum: pp->setPbftSeqNum(string2long(value)); return true;
        case FIELD_pbftSenderId: pp->setPbftSenderId(string2long(value)); return true;
        case FIELD_pbftOriginatorId: pp->setPbftOriginatorId(string2long(value)); return true;
...
EXECUTE_ON_STARTUP(
    omnetpp::cEnum *e = omnetpp::cEnum::find("veins::PBFTMessageType");
    if (!e) omnetpp::enums.getInstance()->add(e = new omnetpp::cEnum("veins::PBFTMessageType"));
    e->insert(PBFT_REQUEST, "PBFT_REQUEST");
    e->insert(PBFT_PREPREPARE, "PBFT_PREPREPARE");
    e->insert(PBFT_PREPARE, "PBFT_PREPARE");
    e->insert(PBFT_COMMIT, "PBFT_COMMIT");
    e->insert(PBFT_REPLY, "PBFT_REPLY");
)
